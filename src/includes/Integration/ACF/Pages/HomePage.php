	...
	public function add_purpose_fields() {
		acf_add_local_field_group(
			...
			'fields' => array(
				array(
					'type' => 'text',
					'key' => 'home_purpose_title',
					'name' => 'home_purpose_title',
					'label' => __( 'Section title', 'elemarjr' ),
				),
				array(
					'type' => 'text',
					'key' => 'home_purpose_icon_1',
					'name' => 'home_purpose_icon_1',
					'label' => __( 'Icon Class 1', 'elemarjr' ),
				),
				array(
					'type' => 'text',
					'key' => 'home_purpose_title_1',
					'name' => 'home_purpose_title_1',
					'label' => __( 'Title 1', 'elemarjr' ),
				),
				array(
					'type' => 'wysiwyg',
					'key' => 'home_purpose_text_1',
					'name' => 'home_purpose_text_1',
					'label' => __( 'Text 1', 'elemarjr' ),
				),
				array(
					'type' => 'text',
					'key' => 'home_purpose_icon_2',
					'name' => 'home_purpose_icon_2',
					'label' => __( 'Icon Class 2', 'elemarjr' ),
				),
				array(
					'type' => 'text',
					'key' => 'home_purpose_title_2',
					'name' => 'home_purpose_title_2',
					'label' => __( 'Title 2', 'elemarjr' ),
				),
				array(
					'type' => 'wysiwyg',
					'key' => 'home_purpose_text_2',
					'name' => 'home_purpose_text_2',
					'label' => __( 'Text 2', 'elemarjr' ),
				),
				array(
					'type' => 'image',
					'key' => 'home_purpose_image',
					'name' => 'home_purpose_image',
